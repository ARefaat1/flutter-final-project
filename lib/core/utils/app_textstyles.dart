...
abstract class AppTextstyles {
  static final TextStyle style15OrangeW600 = GoogleFonts.poppins(
      fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.orangecolor);
  static final TextStyle style15OrangeW400 = GoogleFonts.poppins(
      fontSize: 15, fontWeight: FontWeight.w400, color: AppColors.orangecolor);
  static final TextStyle style24OrangeW900 = GoogleFonts.poppins(
      fontSize: 24, fontWeight: FontWeight.w900, color: AppColors.orangecolor);
  static TextStyle style14Blackw500 = GoogleFonts.poppins(
      fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.blackfont);
  static TextStyle style15BlackW400 = GoogleFonts.poppins(
      fontSize: 15, fontWeight: FontWeight.w400, color: AppColors.blackfont);
  static final TextStyle style14BlackW100 = GoogleFonts.poppins(
    fontSize: 14, fontWeight: FontWeight.w100, color: AppColors.blackfont);
  static final TextStyle style17whiteW500 = GoogleFonts.poppins(
  ...
  static final TextStyle style14BlackW400 = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: AppColors.blackfont,
  );

  static final TextStyle style15WhiteW500 = GoogleFonts.poppins(
      fontSize: 15, fontWeight: FontWeight.w500, color: AppColors.whitefont);

  static final TextStyle style24BlackW900 = GoogleFonts.poppins(
      fontSize: 24, fontWeight: FontWeight.w900, color: AppColors.blackfont);

  static final TextStyle style16BlackW500 = GoogleFonts.poppins(
    fontSize: 16,
